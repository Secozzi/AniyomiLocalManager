...
fun AniDBPreferencesScreen() {
    ...
    AniDBPreferencesScreenContent(
        ...
        onNameFormatClicked = { dialog = Dialog.NameFormat },
        scanlatorFormat = scanlatorFormat,
        onScanlatorFormatClicked = { dialog = Dialog.ScanlatorFormat },
        summaryFormat = summaryFormat,
        onSummaryFormatClicked = { dialog = Dialog.SummaryFormat },
    )

    when (dialog) {
        Dialog.NameFormat -> {
            TextFieldDialog(
                title = stringResource(R.string.pref_anidb_name_format),
        ...
        Dialog.ScanlatorFormat -> {
            TextFieldDialog(
                title = stringResource(R.string.pref_anidb_scanlator_format),
                summary = stringResource(R.string.pref_anidb_replacements),
        ...
        Dialog.SummaryFormat -> {
            TextFieldDialog(
                title = stringResource(R.string.pref_anidb_summary_format),
                summary = stringResource(R.string.pref_anidb_replacements),
...
private sealed interface Dialog {
    data object NameFormat : Dialog
    data object ScanlatorFormat : Dialog
    data object SummaryFormat : Dialog
}
