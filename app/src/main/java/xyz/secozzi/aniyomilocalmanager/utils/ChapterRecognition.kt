 ...
 * -R> = regex conversion.
 */
// From https://github.com/mihonapp/mihon/blob/main/domain/src/main/java/tachiyomi/domain/chapter/service/ChapterRecognition.kt
object ChapterRecognition {
    ...
    fun parseChapterNumber(chapterName: String): Double {
        // Get chapter title with lower case
        val cleanChapterName = chapterName.lowercase().trim()
